...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v3.10.2"
  WORKING_DIRECTORY "/home/rasheek/src/Viridian/d9-NX3PDU-MK3-FWMK1/libraries//json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/rasheek/src/Viridian/d9-NX3PDU-MK3-FWMK1/libraries//json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/rasheek/src/Viridian/d9-NX3PDU-MK3-FWMK1/libraries//json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
